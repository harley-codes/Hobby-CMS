...
function CreateEditorElement(componentProps: PostBlockEditorBaseProps, componentType: string): JSX.Element
{
...
function CreateBlockBaseData(newBlockType: PostBlockTypes): PostBlockListItem
{
